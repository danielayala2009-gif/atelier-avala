const CACHE='atelier-ayala-v4-20260816';
const CORE=['./','index.html','recipes.json','manifest.webmanifest','icon-192.png','icon-512.png','canele.jpg','madeleines.jpg','flan.jpg','bourdaloue.jpg'];
